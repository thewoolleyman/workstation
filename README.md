...
* Editor -> Inspections
  ...
  * Proofreading
    * NOTE on proofreading inspections: If I am working in the IDE with code or text generated by agentic AI workflows, I disable all 'Proofreading' inspections.
      This is for two reasons:
      1. I want to focus on actual logic or syntax errors
      2. AI almost never makes spelling/grammar errors (I think I've only ever seen one spelling error).
    * Typo -> Options -> Uncheck "Process code"
...
* Editor -> Natural Languages (See note above on 'Proofreading' inspection. When working with agentic AI output, I turn off all proofreading inspections).
  * Grammar and Style
...
* Advanced Settings
  ...
  * Rake: (optional) Load tasks automatically: Uncheck (I never use rake tasks from Rubymine, turning it off speeds IDE startup)
